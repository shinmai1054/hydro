function _fish_prompt_login --description 'display user name for the prompt'
...
function fish_prompt --description Hydro
    _fish_prompt_login
    echo -ne " $_hydro_color_pwd$_hydro_pwd$hydro_color_normal $_hydro_color_git$$_hydro_git$hydro_color_normal$_hydro_color_duration$_hydro_cmd_duration$hydro_color_normal$_hydro_status$hydro_color_normal "
end
